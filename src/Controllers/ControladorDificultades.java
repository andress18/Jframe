...
public class ControladorDificultades implements ActionListener {
    ...
    public ControladorDificultades(frmEdades vistaDificultad, frmActividadPeque vistaPeque, frmActividadGrand vistaGrandes, FrmLogin vistaUser, Controlador controlador) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource().equals(vistaDificultad.getBtnCamb()) && vistaDificultad.isVisible()) { // Cuando
            ...
            controlador.cargarImagen(vistaGrandes.getBtnG1(), "src/Recursos/Topicos/pastsimple.png");
            controlador.cargarImagen(vistaGrandes.getBtnG2(), "src/Recursos/Topicos/presentecontinuos.png");
            controlador.cargarImagen(vistaGrandes.getBtnG3(), "src/Recursos/Topicos/irregularverbs.png");
            controlador.cargarImagen(vistaGrandes.getBtnG4(), "src/Recursos/Topicos/date.png");
            ...
            controlador.cargarImagen(vistaPeque.getBtnA2(), "src/Recursos/Topicos/adjectives.png");
            controlador.cargarImagen(vistaPeque.getBtnA3(), "src/Recursos/Topicos/numbers.png");
            controlador.cargarImagen(vistaPeque.getBtnA4(), "src/Recursos/Topicos/prepositions.png");
